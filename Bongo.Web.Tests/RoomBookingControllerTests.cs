...
namespace Bongo.Web
{
    ...
    public class RoomBookingControllerTests
    {
        ...
        [Test]
        public void IndexPage_CallRequest_VerifyGetAllWasInvoked()
        {
        ...
        public void BookRoomCheck_Successful_SuccessCodeAndRedirect()
        {
            ...
            _studyRoomBookingService.Setup(x => x.BookStudyRoom(It.IsAny<StudyRoomBooking>()))
                .Returns((StudyRoomBooking booking)=> new StudyRoomBookingResult() 
                {
                    ...
                    Date = booking.Date, Email =booking.Email,
                });
            //Act 
            var result = _bookingController.Book(new StudyRoomBooking()
            {
                Date = DateTime.Now,
                Email = "Dannilexy@gmail.com",
                FirstName = "Dan",
                LastName = "Eagle",
                StudyRoomId = 1
            });
            ...
            Assert.AreEqual("Dan", actionResult.RouteValues["FirstName"]) ;
